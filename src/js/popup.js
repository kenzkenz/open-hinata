  ...
  switch (layers[0].get('name')) {
    ...
    case 'kyusekki':
      ...
      cont = '<div style=width:300px;font-size:small;>' +
          ...
          '作成者=' + ru(prop.作成者) + '<br>' +
          html +
          // 'ナイフ形石器=' + ru(prop.ナイフ形石器) + '<br>' +
          // '剥片尖頭器=' + ru(prop.剥片尖頭器) + '<br>' +
          // '叩石=' + ru(prop.叩石) + '<br>' +
          // '斧形石器=' + ru(prop.斧形石器) + '<br>' +
          // '細石刃・細石核等=' + ru(prop['細石刃・細石核等']) + '<br>' +
          // '角錐状石器・三稜尖頭器=' + ru(prop['角錐状石器・三稜尖頭器']) + '<br>' +
          // '斧形石器=' + ru(prop.斧形石器) + '' +
          // streetView +
          '</div>'
      break
    ...
    case 'syochiki2020':
      ...
      cont = '<div style=width:200px;>' +
          ...
          '<button class="pyramid-syochiiki-h17" year=2005 mapname="' + map.values_.target + '" cdArea="' + prop.KEY_CODE + '" syochiikiname="' + prop.S_NAME + '">2005人口ピラミッド</button><br><br>' +
